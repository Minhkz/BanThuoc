            ...
            <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-end flex-wrap gap-3 mb-3">
                <div>
                    ...
                    <div class="section-head-desc">
                        Họ tên, số điện thoại, vai trò, trạng thái
                    </div>
                </div>
            ...
            <div class="table-responsive shadow-sm rounded-4 border bg-white">
                <table class="table align-middle mb-0">
                    ...
                    <tbody>
                        <tr class="text-muted text-center">
                            <td colspan="5" class="py-5 small">
                                ...
                                <div class="text-muted small">
                                    Người dùng mới sẽ hiển thị ở đây.
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                <div class="fw-semibold" style="font-size:.9rem;">Nguyễn Văn A</div>
                                <div class="text-muted small">a.nguyen@example.com</div>
                            </td>
                            <td>0901xxx...</td>
                            <td><span class="user-role-badge">Khách hàng</span></td>
                            <td class="text-end">
                                <span class="user-status-active">Đang hoạt động</span>
                            </td>
                            <td class="text-end">
